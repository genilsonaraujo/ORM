...
class Topic(models.Model): #topico tabela no banco de dados
    ...
    cnpj = models.CharField(max_length=14, default='00.000.000/0000-00')
    telefone = models.CharField(max_length=15, default='(00) 0000-0000')
...
class MeuModelo(models.Model):
    ...
    imagem = models.ImageField(upload_to='imagens/')  # Diretório onde as imagens serão salvas
...
class SalaUps(models.Model):
    ...
    data_hora = models.DateTimeField(default=timezone.now)  # Data e hora (inclui hora, minuto, segundo)
