...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'ORMS/static')]
...
DEBUG = True
ALLOWED_HOSTS = ['localhost', '127.0.0.1'] #'api-django-4b2c63e2dc99.herokuapp.com', 
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # Corrija aqui
        'NAME': BASE_DIR / 'db.sqlite3',  # Ou o caminho correto para seu banco de dados
    }
}
